...
1. If the guardian is not already running (check `~/.jugaad-code/guardian.pid` exists and `~/.jugaad-code/state.json` is fresh), start it in the background: `python scripts/guardian.py`.
