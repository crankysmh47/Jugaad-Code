...
Steps:
1. Run `python3 scripts/power_check.py` (or `python scripts/power_check.py`) and parse the JSON output.
2. Run `python3 scripts/isp_detect.py` (or `python scripts/isp_detect.py`) and parse the JSON output.
3. Run `python3 scripts/net_check.py` (or `python scripts/net_check.py`) and parse the JSON output.
4. Run `python3 scripts/survival_mode.py --json` to get current state and adaptive protections.
